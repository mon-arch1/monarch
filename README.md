...
local Window = Rayfield:CreateWindow({
   ...
   LoadingTitle = "you are an idiot",
   LoadingSubtitle = "by Zohir",
   Theme = "blood", -- Check https://[Log in to view URL]
   ...
   KeySettings = {
      Title = "monarch",
      Subtitle = "get the key for start",
...
Rayfield:Notify({
   Title = "welcome my shadow army",
   Content = "you have used the script that created by the monarch",
   Duration = 3.4,
   Image = nil,
})
